  ...
  return (
    <div className="space-y-6">
      <StitchCard variant="surface-low">
        <div className="mb-4">
          <h2 className="text-xl font-bold">마스터 데이터 관리</h2>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="tests"><TestItemManager /></TabsContent>
          <TabsContent value="prices"><PriceManager /></TabsContent>
          <TabsContent value="packages"><PackageManager /></TabsContent>
          <TabsContent value="efficacy"><EfficacyMasterManager /></TabsContent>
          <TabsContent value="clinical"><ClinicalPathologyMasterManager /></TabsContent>
        </Tabs>
      </StitchCard>
    </div>
  );
