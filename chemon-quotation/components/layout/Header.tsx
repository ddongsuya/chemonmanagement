...
export default function Header({ title }: HeaderProps) {
  ...
  return (
    <header className="h-14 bg-white/80 backdrop-blur-md border-b border-slate-100 flex items-center justify-between px-4 md:px-6 sticky top-0 z-30 shadow-sm">
      {/* 좌측: 타이틀 */}
        ...
        <div className="hidden md:flex items-center" ref={searchRef}>
          <div className="relative">
            ...
            <Input
              ...
              className="w-72 pl-9 pr-8 bg-slate-100 border-none rounded-full focus:ring-2 focus:ring-primary/20 text-sm"
              value={searchQuery}
