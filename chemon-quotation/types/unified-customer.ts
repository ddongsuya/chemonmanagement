 ...
 * 
 * 리드(Lead)와 고객(Customer)을 통합하여 표시하기 위한 프론트엔드 타입 정의
 * 
 * @module types/unified-customer
 ...
 * 엔티티 유형별 배지 설정
 */
export const ENTITY_TYPE_BADGE_CONFIG: Record<EntityType, { label: string; className: string }> = {
