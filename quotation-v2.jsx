...
const HF_INDV=[{id:1,num:1,n:"투여물질의 조제물 분석",fn:"투여물질의 조제물 분석",c:"조제물분석",s:"-",d:"-",desc:"- 조제물분석법 Validation\n- 해당일 조제물에서 상중하 1ml씩 채취하여 분석 실시(HPLC)\n- 균질성, 안전성 및 함량 측정\n- 분석법 및 표준품 의뢰자 제공",p:26000000,w:"6~",gl:["","","건강기능식품 기능성 및 안전성 평가 가이드","투여 조제물의 균질성, 안정성 및 함량을 HPLC 등으로 분석하여 투여량의 정확성 확보"]},{id:2,num:2,n:"급성 경구독성시험",fn:"급성 경구독성시험 (독성등급법: OECD TG423)",c:"단회투여독성",s:"SD rat",d:"1회",desc:"- 독성등급법(TG423)\n- 일반증상, 체중 및 부검 관찰\n- 14일간 관찰",p:2700000,w:7,gl:["OECD TG 423","","식품의약품안전처 고시","독성등급법으로 단회 경구투여 후 14일간 관찰하여 급성독성 프로파일 평가"]},{id:3,num:3,n:"설치류 4주 DRF",fn:"설치류 4주 투여 DRF 시험 (용량결정시험)",c:"반복투여독성",s:"SD rat",d:"4주",desc:"- 암수 각각 5마리/군\n- 대조군 1, 시험군 3",p:14400000,w:8,gl:["OECD TG 407","ICH M3(R2), ICH S4","식품의약품안전처 고시","13주 본시험의 용량 설정을 위한 DRF"]},{id:4,num:4,n:"설치류 13주 반복투여 독성",fn:"설치류 13주 반복 투여 독성시험 (OECD TG 408 반영)",c:"반복투여독성",s:"SD rat",d:"13주",desc:"- 암수 각각 10마리/군, 대조군 1, 시험군 3\n- 주요군: 80마리\n\n*TG408 개정 추가*\n1. 호르몬: T4, T3, TSH\n2. 혈액생화학: LDL, HDL\n3. 암컷 성주기 검사",p:92000000,w:27,gl:["OECD TG 408","ICH M3(R2), ICH S4","식품의약품안전처 고시","13주간 반복투여 아만성독성 평가. TG408 개정 반영"]},{id:5,num:5,n:"유전독성: Ames(TG471)",fn:"유전독성시험 : 복귀 돌연변이 (OECD TG471)",c:"유전독성",s:"-",d:"-",desc:"- 5개 균주(TA100,TA1535,TA98,TA1537,WP2uvrA)\n- 복귀돌연변이 집락 수 관찰\n- 예비시험 포함",p:5600000,w:5,gl:["OECD TG 471","ICH S2(R1)","식품의약품안전처 고시","5개 균주 복귀돌연변이시험"],note:"재현성 추가시험 시 +200만원"},{id:6,num:6,n:"유전독성: 염색체이상(TG473)",fn:"유전독성시험 : 염색체 이상 시험 (OECD TG473)",c:"유전독성",s:"Cell",d:"-",desc:"- CHL 세포\n- 구조/수적 이상 관찰\n- 예비시험 포함",p:13000000,w:9,gl:["OECD TG 473","ICH S2(R1)","식품의약품안전처 고시","CHL 세포 염색체이상시험"]},{id:7,num:7,n:"유전독성: 소핵시험(TG474)",fn:"유전독성시험 : 소핵시험 (OECD TG474)",c:"유전독성",s:"SD rat",d:"-",desc:"- 6마리/군, 총 5군\n- 골수 미성숙 적혈구내 소핵관찰\n- 예비시험 포함",p:15500000,w:9,gl:["OECD TG 474","ICH S2(R1)","식품의약품안전처 고시","설치류 골수 적혈구 소핵시험"]}];
const HF_INDV_CATS=["전체","조제물분석","단회투여독성","반복투여독성","유전독성"];
// === Health Food (프로바이오틱스) Data ===
const HF_PROB=[{id:1,num:1,n:"투여물질의 조제물 분석",fn:"투여물질의 조제물 분석",c:"조제물분석",s:"-",d:"-",desc:"- 조제물분석법 Validation\n- HPLC 분석\n- 균질성, 안전성 및 함량 측정",p:26000000,w:"6~",gl:["","","건강기능식품 기능성 및 안전성 평가 가이드","투여 조제물의 균질성, 안정성 및 함량을 HPLC 등으로 분석"]},{id:2,num:2,n:"설치류 단회 투여 독성시험",fn:"설치류 단회 투여 독성시험",c:"단회투여독성",s:"SD rat",d:"1회",desc:"- 암수 각각 5마리/군\n- 대조군 1, 시험군 3",p:3200000,w:7,gl:["OECD TG 420/423/425","","식품의약품안전처 고시","단회 경구투여 후 14일간 관찰하여 급성독성 프로파일 평가"]},{id:3,num:3,n:"설치류 4주 DRF",fn:"설치류 4주 투여 DRF 시험 (용량결정시험)",c:"반복투여독성",s:"SD rat",d:"4주",desc:"- 암수 각각 5마리/군\n- 대조군 1, 시험군 3",p:14400000,w:8,gl:["OECD TG 407","ICH M3(R2), ICH S4","식품의약품안전처 고시","13주 본시험의 용량 설정을 위한 DRF"]},{id:4,num:4,n:"설치류 13주 반복투여 독성",fn:"설치류 13주 반복 투여 독성시험 (OECD TG 408 반영)",c:"반복투여독성",s:"SD rat",d:"13주",desc:"- 암수 각각 10마리/군, 대조군 1, 시험군 3\n- 주요군: 80마리\n\n*TG408 개정 추가*\n1. 호르몬: T4, T3, TSH\n2. 혈액생화학: LDL, HDL\n3. 암컷 성주기 검사",p:92000000,w:27,gl:["OECD TG 408","ICH M3(R2), ICH S4","식품의약품안전처 고시","13주간 반복투여 아만성독성 평가. TG408 개정 반영"],note:"성호르몬 추가 시 비용 발생"},{id:5,num:5,n:"설치류 13주 반복 4주 회복",fn:"설치류 13주 반복 투여 4주 회복시험 (OECD TG 408 반영)",c:"반복투여독성",s:"SD rat",d:"13주",desc:"- 암수 각각 5마리/군, 대조군 1, 시험군 1\n- 회복군: 20마리\n\n*TG408 개정 추가*\n1. 호르몬: T4, T3, TSH\n2. 혈액생화학: LDL, HDL\n3. 암컷 성주기 검사",p:26000000,w:31,gl:["OECD TG 408","ICH M3(R2), ICH S4","식품의약품안전처 고시","본시험 후 4주 회복기 가역성 평가. TG408 개정 반영"]}];
const HF_PROB_CATS=["전체","조제물분석","단회투여독성","반복투여독성"];
// === Health Food (한시적식품) Data ===
const HF_TEMP=[{id:1,num:1,n:"투여물질의 조제물 분석",fn:"투여물질의 조제물 분석",c:"조제물분석",s:"-",d:"-",desc:"- 조제물분석법 Validation\n- HPLC 분석\n- 균질성, 안전성 및 함량 측정\n- 분석법 및 표준품 의뢰자 제공",p:26000000,w:"6~",gl:["","","건강기능식품 기능성 및 안전성 평가 가이드","투여 조제물의 균질성, 안정성 및 함량을 HPLC 등으로 분석"]},{id:2,num:2,n:"급성 경구독성시험",fn:"급성 경구독성시험 (독성등급법: OECD TG423)",c:"단회투여독성",s:"SD rat",d:"1회",desc:"- 독성등급법(TG423)\n- 일반증상, 체중 및 부검\n- 14일간 관찰",p:2700000,w:7,gl:["OECD TG 423","","식품의약품안전처 고시","독성등급법으로 단회 경구투여 후 14일간 관찰"]},{id:3,num:3,n:"설치류 4주 DRF",fn:"설치류 4주 투여 DRF 시험 (용량결정시험)",c:"반복투여독성",s:"SD rat",d:"4주",desc:"- 암수 각각 5마리/군\n- 대조군 1, 시험군 3",p:14400000,w:8,gl:["OECD TG 407","ICH M3(R2), ICH S4","식품의약품안전처 고시","13주 본시험의 용량 설정을 위한 DRF"]},{id:4,num:4,n:"설치류 13주 반복투여 독성",fn:"설치류 13주 반복 투여 독성시험 (OECD TG 408 반영)",c:"반복투여독성",s:"SD rat",d:"13주",desc:"- 암수 각각 10마리/군, 대조군 1, 시험군 3\n- 주요군: 80마리\n\n*TG408 개정 추가*\n1. 호르몬: T4, T3, TSH\n2. 혈액생화학: LDL, HDL\n3. 암컷 성주기 검사",p:92000000,w:27,gl:["OECD TG 408","ICH M3(R2), ICH S4","식품의약품안전처 고시","13주간 반복투여 아만성독성 평가. TG408 개정 반영"],note:"성호르몬 추가 시 비용 발생"},{id:5,num:5,n:"설치류 13주 반복 4주 회복",fn:"설치류 13주 반복 투여 4주 회복시험 (OECD TG 408 반영)",c:"반복투여독성",s:"SD rat",d:"13주",desc:"- 암수 각각 5마리/군, 대조군 1, 시험군 1\n- 회복군: 20마리\n\n*TG408 개정 추가*\n1. 호르몬: T4, T3, TSH\n2. 혈액생화학: LDL, HDL\n3. 암컷 성주기 검사",p:26000000,w:31,gl:["OECD TG 408","ICH M3(R2), ICH S4","식품의약품안전처 고시","본시험 후 4주 회복기 가역성 평가. TG408 개정 반영"]},{id:6,num:6,n:"유전독성: Ames(TG471)",fn:"유전독성시험 : 복귀 돌연변이 (OECD TG471)",c:"유전독성",s:"-",d:"-",desc:"- 5개 균주(TA100,TA1535,TA98,TA1537,WP2uvrA)\n- 복귀돌연변이 집락 수 관찰\n- 예비시험 포함",p:5600000,w:5,gl:["OECD TG 471","ICH S2(R1)","식품의약품안전처 고시","5개 균주 복귀돌연변이시험"],note:"재현성 추가시험 시 +200만원"},{id:7,num:7,n:"유전독성: 염색체이상(TG473)",fn:"유전독성시험 : 염색체 이상 시험 (OECD TG473)",c:"유전독성",s:"Cell",d:"-",desc:"- CHL 세포\n- 구조/수적 이상 관찰\n- 예비시험 포함",p:13000000,w:9,gl:["OECD TG 473","ICH S2(R1)","식품의약품안전처 고시","CHL 세포 염색체이상시험"]},{id:8,num:8,n:"유전독성: 소핵시험(TG474)",fn:"유전독성시험 : 소핵시험 (OECD TG474)",c:"유전독성",s:"SD rat",d:"-",desc:"- 6마리/군, 총 5군\n- 골수 미성숙 적혈구내 소핵관찰\n- 예비시험 포함",p:15500000,w:9,gl:["OECD TG 474","ICH S2(R1)","식품의약품안전처 고시","설치류 골수 적혈구 소핵시험"]}];
...
{id:3,num:3,n:"설치류 4주 DRF",fn:"설치류 4주 투여 DRF 시험",c:"반복투여독성",s:"SD rat",d:"4주",desc:"- 암수 각각 5마리/군\n- 2종: 대조1+복합3+단일2 (6군)\n- 3종: 대조1+복합3+단일3 (7군)\n- 4종: 대조1+복합3+단일4 (8군)\n\n1. 일반증상, 체중측정\n2. 뇨/안검사, 사료/음용수 섭취량\n3. 부검/장기중량, 혈액학/생화학\n4. 이상장기 고정\n* 예비시험 포함(non-GLP)",p2:28000000,p3:33000000,p4:40000000,w:10,gl:["OECD TG 407","ICH M3(R2), ICH S4","독성시험기준 제6조","복합제+단일제 군 구성 DRF"]},
{id:4,num:4,n:"설치류 13주 반복투여",fn:"설치류 13주 반복 투여 독성시험",c:"반복투여독성",s:"SD rat",d:"13주",desc:"- 암수 각각 10마리/군\n- 2종: 대조1+복합3+단일2 (6군)\n- 3종: 대조1+복합3+단일3 (7군)\n- 4종: 대조1+복합3+단일4 (8군)\n\n1. 일반증상, 체중\n2. 뇨/안검사, 사료/음용수\n3. 부검/장기중량, 혈액학/생화학/응고\n4. 조직병리: 대조, 단일제, 복합최고용량\n   (이상장기→모든 군)",p2:165000000,p3:199000000,p4:241000000,w:32,gl:["OECD TG 408","ICH M3(R2), ICH S4","독성시험기준 제6조","복합제 vs 단일제 비교 아만성독성 평가"]},
...
{id:9,num:9,n:"복귀돌연변이",fn:"유전독성시험: 복귀 돌연변이",c:"유전독성",s:"균",d:"-",desc:"- 극성/비극성 용출 2조건\n- 대장균 1균, 살모넬라균 4균\n- 돌연변이 집락 관찰",p:3500000,w:8,gl:["ISO 10993-3, 10993-33","OECD TG 471","","5균주 복귀돌연변이, 2조건"],note:"독성 시 비용/기간 추가"},
{id:10,num:10,n:"염색체이상",fn:"유전독성시험: 염색체 이상 시험",c:"유전독성",s:"Cell",d:"-",desc:"- 배양액 용출 2조건\n- 햄스터 폐 세포\n- 구조/수적 이상 관찰",p:8000000,w:10,gl:["ISO 10993-3, 10993-33","OECD TG 473","","햄스터 폐 세포, 용출 2조건"],note:"독성 시 비용/기간 추가"},
...
export default function App(){
  const[mode,setMode]=useState(""); // ""=top, drug/drug_single/drug_combo/drug_vaccine/drug_screen/drug_screen_tox/drug_screen_cv, hf/hf_indv/hf_prob/hf_temp, md/md_bio
  ...
  const isSimple=isHF||isCombo||isVaccine||isScreen||isMD;
  const curData=isCombo?COMBO:isVaccine?VACCINE:mode==="drug_screen_tox"?SCREEN:mode==="drug_screen_cv"?CV_SCREEN:isMD?MD_BIO:mode==="hf_indv"?HF_INDV:mode==="hf_prob"?HF_PROB:mode==="hf_temp"?HF_TEMP:D;
  const curCats=isCombo?COMBO_CATS:isVaccine?VACCINE_CATS:mode==="drug_screen_tox"?SCREEN_CATS:mode==="drug_screen_cv"?CV_SCREEN_CATS:isMD?MD_BIO_CATS:mode==="hf_indv"?HF_INDV_CATS:mode==="hf_prob"?HF_PROB_CATS:mode==="hf_temp"?HF_TEMP_CATS:CATS;
  const modeLabel=isCombo?`복합제(${comboType}종)`:isVaccine?"백신":mode==="drug_screen_tox"?"독성 스크리닝":mode==="drug_screen_cv"?"심혈관계 스크리닝":isMD?"의료기기(생물학적안전성)":mode==="hf_indv"?"건기식(개별인정형)":mode==="hf_prob"?"건기식(프로바이오틱스)":mode==="hf_temp"?"건기식(한시적식품)":"의약품";
...
<style>*{margin:0;padding:0;box-sizing:border-box}body{font-family:'Noto Sans KR',sans-serif;color:#1a1a1a;font-size:11px}@page{size:A4;margin:15mm 20mm}.pb{page-break-before:always}table{width:100%;border-collapse:collapse}th,td{border:1px solid #c8c8c8;padding:5px 8px}th{background:#1a365d;color:#fff;font-weight:500;font-size:10px}.r{text-align:right}.c{text-align:center}.l{text-align:left}.db{margin-bottom:14px;border:1px solid #d1d5db;border-radius:4px;overflow:hidden}.dh{background:#f1f5f9;padding:7px 12px;font-weight:600;font-size:11px;border-bottom:1px solid #d1d5db}.dd{padding:10px 14px;font-size:10px;white-space:pre-line;line-height:1.7;color:#374151}.bg{display:inline-block;padding:1px 8px;border-radius:10px;font-size:9px;color:#fff;margin-left:6px}</style></head><body>`);
              ...
              <div style={{minHeight:"100vh",display:"flex",flexDirection:"column",padding:40}}>
                <div style={{flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",textAlign:"center"}}>
                  ...
                  <table style={{width:300,borderCollapse:"collapse",fontSize:12,textAlign:"left"}}>
                    <tbody>
                      {[["견적번호",info.qn],["발행일",ds],["시험물질",info.substance||"-"],["제출목적",isMD?"의료기기 생물학적 안전성시험":(mode==="drug_screen_cv"?"안전성약리 심혈관계 스크리닝":(mode==="drug_screen_tox"?"독성 스크리닝 시험":(isVaccine?"백신 독성시험":(isCombo?`복합제(${comboType}종) 독성시험`:(isHF?(mode==="hf_prob"?"건강기능식품 프로바이오틱스 독성시험":mode==="hf_temp"?"건강기능식품 한시적식품 독성시험":"건강기능식품 개별인정형 독성시험"):info.purpose)))))],["시험기준",isMD?"KGLP":(isSimple?(mode==="drug_screen_cv"?"KGLP (MEA: GLP)":"non-GLP"):isDrug?std:"KGLP")],["투여경로",isMD?"-":(isScreen?"-":(isVaccine?"근육":(isCombo?"경구":(isHF?hfRoute:route))))]].map(([l,v])=>(
  ...
  if(!mode||mode==="hf"||mode==="drug"||mode==="drug_screen"||mode==="md") return(
    <div style={{minHeight:"100vh",background:"linear-gradient(135deg,#0f172a,#1e293b)",fontFamily:"'Noto Sans KR',system-ui,sans-serif",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:24}}>
      <div style={{textAlign:"center",color:"#fff",marginBottom:16}}>
        ...
        {mode==="hf"&&<div style={{marginTop:12,fontSize:14,color:"#86efac"}}>🥗 건강기능식품 — 하위 카테고리를 선택하세요</div>}
        {mode==="drug"&&<div style={{marginTop:12,fontSize:14,color:"#93c5fd"}}>💊 의약품 — 하위 카테고리를 선택하세요</div>}
        {mode==="drug_screen"&&<div style={{marginTop:12,fontSize:14,color:"#fdba74"}}>🔬 스크리닝 — 하위 카테고리를 선택하세요</div>}
        {mode==="md"&&<div style={{marginTop:12,fontSize:14,color:"#5eead4"}}>🏥 의료기기 — 하위 카테고리를 선택하세요</div>}
      </div>
      {(mode==="hf"||mode==="drug"||mode==="md")&&<button onClick={()=>setMode("")} style={{background:"rgba(255,255,255,.1)",border:"none",borderRadius:6,padding:"6px 16px",cursor:"pointer",color:"#fff",fontSize:12,marginBottom:8}}>← 처음으로</button>}
      ...
      <div style={{display:"flex",gap:20,flexWrap:"wrap",justifyContent:"center"}}>
        {!mode&&<>
          <div onClick={()=>setMode("drug")} style={{width:260,padding:"32px 24px",background:"rgba(255,255,255,.06)",border:"2px solid rgba(255,255,255,.1)",borderRadius:16,cursor:"pointer",textAlign:"center"}} onMouseEnter={e=>{e.currentTarget.style.background="rgba(255,255,255,.12)";e.currentTarget.style.borderColor="#2563eb";}} onMouseLeave={e=>{e.currentTarget.style.background="rgba(255,255,255,.06)";e.currentTarget.style.borderColor="rgba(255,255,255,.1)";}}>
            <div style={{fontSize:48,marginBottom:12}}>💊</div>
            <div style={{fontSize:18,fontWeight:700,color:"#fff",marginBottom:6}}>의약품</div>
            <div style={{fontSize:12,color:"rgba(255,255,255,.5)",whiteSpace:"pre-line",lineHeight:1.6}}>{"의약품 · 복합제 · 백신 · 스크리닝\n104개+ 시험항목 · KGLP/OECD"}</div>
          </div>
          <div onClick={()=>setMode("hf")} style={{width:260,padding:"32px 24px",background:"rgba(255,255,255,.06)",border:"2px solid rgba(255,255,255,.1)",borderRadius:16,cursor:"pointer",textAlign:"center"}} onMouseEnter={e=>{e.currentTarget.style.background="rgba(255,255,255,.12)";e.currentTarget.style.borderColor="#059669";}} onMouseLeave={e=>{e.currentTarget.style.background="rgba(255,255,255,.06)";e.currentTarget.style.borderColor="rgba(255,255,255,.1)";}}>
            <div style={{fontSize:48,marginBottom:12}}>🥗</div>
            <div style={{fontSize:18,fontWeight:700,color:"#fff",marginBottom:6}}>건강기능식품</div>
            <div style={{fontSize:12,color:"rgba(255,255,255,.5)",whiteSpace:"pre-line",lineHeight:1.6}}>{"개별인정형 · 프로바이오틱스\n한시적식품"}</div>
          </div>
          <div onClick={()=>setMode("md")} style={{width:260,padding:"32px 24px",background:"rgba(255,255,255,.06)",border:"2px solid rgba(255,255,255,.1)",borderRadius:16,cursor:"pointer",textAlign:"center"}} onMouseEnter={e=>{e.currentTarget.style.background="rgba(255,255,255,.12)";e.currentTarget.style.borderColor="#0d9488";}} onMouseLeave={e=>{e.currentTarget.style.background="rgba(255,255,255,.06)";e.currentTarget.style.borderColor="rgba(255,255,255,.1)";}}>
            <div style={{fontSize:48,marginBottom:12}}>🏥</div>
            <div style={{fontSize:18,fontWeight:700,color:"#fff",marginBottom:6}}>의료기기</div>
            <div style={{fontSize:12,color:"rgba(255,255,255,.5)",whiteSpace:"pre-line",lineHeight:1.6}}>{"생물학적 안전성시험\nISO 10993 · KGLP"}</div>
          </div>
          <div style={{width:260,padding:"32px 24px",background:"rgba(255,255,255,.03)",border:"2px dashed rgba(255,255,255,.1)",borderRadius:16,textAlign:"center",opacity:.4}}>
            <div style={{fontSize:48,marginBottom:12}}>💄</div>
            <div style={{fontSize:18,fontWeight:700,color:"#fff",marginBottom:6}}>화장품</div>
            <div style={{fontSize:12,color:"rgba(255,255,255,.5)"}}>{"대체법 · 줄기세포배양액\n추가 예정"}</div>
          </div>
        </>}
        {mode==="drug"&&<>
          <div onClick={()=>{setMode("drug_single");setSel({});setOpts({});setCat("전체");setSearch("");}} style={{width:240,padding:"28px 20px",background:"rgba(255,255,255,.06)",border:"2px solid rgba(255,255,255,.1)",borderRadius:16,cursor:"pointer",textAlign:"center"}} onMouseEnter={e=>{e.currentTarget.style.background="rgba(255,255,255,.12)";e.currentTarget.style.borderColor="#2563eb";}} onMouseLeave={e=>{e.currentTarget.style.background="rgba(255,255,255,.06)";e.currentTarget.style.borderColor="rgba(255,255,255,.1)";}}>
            <div style={{fontSize:40,marginBottom:10}}>💉</div>
            <div style={{fontSize:16,fontWeight:700,color:"#fff",marginBottom:6}}>의약품</div>
            <div style={{fontSize:11,color:"rgba(255,255,255,.5)",lineHeight:1.6}}>{"104개 시험항목 · KGLP/OECD\n경구/정맥 가격 분리"}</div>
          </div>
          <div onClick={()=>{setMode("drug_combo");setSel({});setOpts({});setCat("전체");setSearch("");setComboType(2);}} style={{width:240,padding:"28px 20px",background:"rgba(255,255,255,.06)",border:"2px solid rgba(255,255,255,.1)",borderRadius:16,cursor:"pointer",textAlign:"center"}} onMouseEnter={e=>{e.currentTarget.style.background="rgba(255,255,255,.12)";e.currentTarget.style.borderColor="#7c3aed";}} onMouseLeave={e=>{e.currentTarget.style.background="rgba(255,255,255,.06)";e.currentTarget.style.borderColor="rgba(255,255,255,.1)";}}>
            <div style={{fontSize:40,marginBottom:10}}>💊💊</div>
            <div style={{fontSize:16,fontWeight:700,color:"#fff",marginBottom:6}}>복합제</div>
            <div style={{fontSize:11,color:"rgba(255,255,255,.5)",lineHeight:1.6}}>{"2종/3종/4종 · KGLP\n복합제+단일제 군 구성"}</div>
          </div>
          <div onClick={()=>{setMode("drug_vaccine");setSel({});setOpts({});setCat("전체");setSearch("");}} style={{width:240,padding:"28px 20px",background:"rgba(255,255,255,.06)",border:"2px solid rgba(255,255,255,.1)",borderRadius:16,cursor:"pointer",textAlign:"center"}} onMouseEnter={e=>{e.currentTarget.style.background="rgba(255,255,255,.12)";e.currentTarget.style.borderColor="#0891b2";}} onMouseLeave={e=>{e.currentTarget.style.background="rgba(255,255,255,.06)";e.currentTarget.style.borderColor="rgba(255,255,255,.1)";}}>
            <div style={{fontSize:40,marginBottom:10}}>🧬</div>
            <div style={{fontSize:16,fontWeight:700,color:"#fff",marginBottom:6}}>백신</div>
            <div style={{fontSize:11,color:"rgba(255,255,255,.5)",lineHeight:1.6}}>{"3개 시험항목 · KGLP\n반복투여+회복+항체형성"}</div>
          </div>
          <div onClick={()=>setMode("drug_screen")} style={{width:240,padding:"28px 20px",background:"rgba(255,255,255,.06)",border:"2px solid rgba(255,255,255,.1)",borderRadius:16,cursor:"pointer",textAlign:"center"}} onMouseEnter={e=>{e.currentTarget.style.background="rgba(255,255,255,.12)";e.currentTarget.style.borderColor="#ea580c";}} onMouseLeave={e=>{e.currentTarget.style.background="rgba(255,255,255,.06)";e.currentTarget.style.borderColor="rgba(255,255,255,.1)";}}>
            <div style={{fontSize:40,marginBottom:10}}>🔬</div>
            <div style={{fontSize:16,fontWeight:700,color:"#fff",marginBottom:6}}>스크리닝</div>
            <div style={{fontSize:11,color:"rgba(255,255,255,.5)",lineHeight:1.6}}>{"독성시험 · 심혈관계\nnon-GLP 탐색시험"}</div>
          </div>
        </>}
        {mode==="drug_screen"&&<>
          <div onClick={()=>{setMode("drug_screen_tox");setSel({});setOpts({});setCat("전체");setSearch("");}} style={{width:240,padding:"28px 20px",background:"rgba(255,255,255,.06)",border:"2px solid rgba(255,255,255,.1)",borderRadius:16,cursor:"pointer",textAlign:"center"}} onMouseEnter={e=>{e.currentTarget.style.background="rgba(255,255,255,.12)";e.currentTarget.style.borderColor="#ea580c";}} onMouseLeave={e=>{e.currentTarget.style.background="rgba(255,255,255,.06)";e.currentTarget.style.borderColor="rgba(255,255,255,.1)";}}>
            <div style={{fontSize:40,marginBottom:10}}>🧪</div>
            <div style={{fontSize:16,fontWeight:700,color:"#fff",marginBottom:6}}>독성시험 스크리닝</div>
            <div style={{fontSize:11,color:"rgba(255,255,255,.5)",lineHeight:1.6}}>{"8개 시험항목 · non-GLP\n단회+반복+유전독성+hERG"}</div>
          </div>
          <div onClick={()=>{setMode("drug_screen_cv");setSel({});setOpts({});setCat("전체");setSearch("");}} style={{width:240,padding:"28px 20px",background:"rgba(255,255,255,.06)",border:"2px solid rgba(255,255,255,.1)",borderRadius:16,cursor:"pointer",textAlign:"center"}} onMouseEnter={e=>{e.currentTarget.style.background="rgba(255,255,255,.12)";e.currentTarget.style.borderColor="#dc2626";}} onMouseLeave={e=>{e.currentTarget.style.background="rgba(255,255,255,.06)";e.currentTarget.style.borderColor="rgba(255,255,255,.1)";}}>
            <div style={{fontSize:40,marginBottom:10}}>❤️</div>
            <div style={{fontSize:16,fontWeight:700,color:"#fff",marginBottom:6}}>심혈관계 스크리닝</div>
            <div style={{fontSize:11,color:"rgba(255,255,255,.5)",lineHeight:1.6}}>{"6개 시험항목\nIon Channel+MEA+Telemetry"}</div>
          </div>
        </>}
        {mode==="md"&&<>
          <div onClick={()=>{setMode("md_bio");setSel({});setOpts({});setCat("전체");setSearch("");}} style={{width:240,padding:"28px 20px",background:"rgba(255,255,255,.06)",border:"2px solid rgba(255,255,255,.1)",borderRadius:16,cursor:"pointer",textAlign:"center"}} onMouseEnter={e=>{e.currentTarget.style.background="rgba(255,255,255,.12)";e.currentTarget.style.borderColor="#0d9488";}} onMouseLeave={e=>{e.currentTarget.style.background="rgba(255,255,255,.06)";e.currentTarget.style.borderColor="rgba(255,255,255,.1)";}}>
            <div style={{fontSize:40,marginBottom:10}}>🧫</div>
            <div style={{fontSize:16,fontWeight:700,color:"#fff",marginBottom:6}}>생물학적 안전성시험</div>
            <div style={{fontSize:11,color:"rgba(255,255,255,.5)",lineHeight:1.6}}>{"18개 시험항목 · KGLP\nISO 10993 시리즈"}</div>
          </div>
        </>}
        {mode==="hf"&&<>
          <div onClick={()=>{setMode("hf_indv");setSel({});setOpts({});setCat("전체");setSearch("");}} style={{width:240,padding:"28px 20px",background:"rgba(255,255,255,.06)",border:"2px solid rgba(255,255,255,.1)",borderRadius:16,cursor:"pointer",textAlign:"center"}} onMouseEnter={e=>{e.currentTarget.style.background="rgba(255,255,255,.12)";e.currentTarget.style.borderColor="#059669";}} onMouseLeave={e=>{e.currentTarget.style.background="rgba(255,255,255,.06)";e.currentTarget.style.borderColor="rgba(255,255,255,.1)";}}>
            <div style={{fontSize:40,marginBottom:10}}>📋</div>
            <div style={{fontSize:16,fontWeight:700,color:"#fff",marginBottom:6}}>개별인정형</div>
            <div style={{fontSize:11,color:"rgba(255,255,255,.5)",lineHeight:1.6}}>{"7개 시험항목 · KGLP\n단회+반복+유전독성"}</div>
          </div>
          <div onClick={()=>{setMode("hf_prob");setSel({});setOpts({});setCat("전체");setSearch("");}} style={{width:240,padding:"28px 20px",background:"rgba(255,255,255,.06)",border:"2px solid rgba(255,255,255,.1)",borderRadius:16,cursor:"pointer",textAlign:"center"}} onMouseEnter={e=>{e.currentTarget.style.background="rgba(255,255,255,.12)";e.currentTarget.style.borderColor="#10b981";}} onMouseLeave={e=>{e.currentTarget.style.background="rgba(255,255,255,.06)";e.currentTarget.style.borderColor="rgba(255,255,255,.1)";}}>
            <div style={{fontSize:40,marginBottom:10}}>🦠</div>
            <div style={{fontSize:16,fontWeight:700,color:"#fff",marginBottom:6}}>프로바이오틱스</div>
            <div style={{fontSize:11,color:"rgba(255,255,255,.5)",lineHeight:1.6}}>{"4개 시험항목 · KGLP\n단회+반복 (유전독성 제외)"}</div>
          </div>
          <div onClick={()=>{setMode("hf_temp");setSel({});setOpts({});setCat("전체");setSearch("");}} style={{width:240,padding:"28px 20px",background:"rgba(255,255,255,.06)",border:"2px solid rgba(255,255,255,.1)",borderRadius:16,cursor:"pointer",textAlign:"center"}} onMouseEnter={e=>{e.currentTarget.style.background="rgba(255,255,255,.12)";e.currentTarget.style.borderColor="#f59e0b";}} onMouseLeave={e=>{e.currentTarget.style.background="rgba(255,255,255,.06)";e.currentTarget.style.borderColor="rgba(255,255,255,.1)";}}>
            <div style={{fontSize:40,marginBottom:10}}>📝</div>
            <div style={{fontSize:16,fontWeight:700,color:"#fff",marginBottom:6}}>한시적식품</div>
            <div style={{fontSize:11,color:"rgba(255,255,255,.5)",lineHeight:1.6}}>{"8개 시험항목 · KGLP\n단회+반복+유전독성+회복확정"}</div>
          </div>
        </>}
      </div>
    </div>
    ...
    <div style={{minHeight:"100vh",background:"#f0f2f5",fontFamily:"'Noto Sans KR',system-ui,sans-serif",color:"#1a1a1a"}}>
      <div style={{background:"linear-gradient(135deg,#1a365d,#2d4a7a)",color:"#fff",padding:"12px 24px",display:"flex",alignItems:"center",justifyContent:"space-between"}}>
        <div style={{display:"flex",alignItems:"center",gap:12}}>
          <button onClick={()=>{const parent=isHF?"hf":isScreen?"drug_screen":isMD?"md":(isDrug||isCombo||isVaccine)?"drug":"";setMode(parent);setSel({});setOpts({});setPage("edit");}} style={{background:"rgba(255,255,255,.1)",border:"none",borderRadius:6,padding:"5px 10px",cursor:"pointer",color:"#fff",fontSize:11}}>← 돌아가기</button>
          <div>
            <div style={{display:"flex",alignItems:"center",gap:8}}>
              <span style={{fontSize:16,fontWeight:700,letterSpacing:2}}>독성시험 견적서 생성기</span>
              <span style={{fontSize:11,padding:"2px 10px",borderRadius:10,background:isMD?"#0d9488":isScreen?"#ea580c":isVaccine?"#0891b2":isCombo?"#7c3aed":isHF?"#059669":"#2563eb",fontWeight:600}}>{modeLabel}</span>
            </div>
