...
- v1.0.0: 초기 릴리스
      ...
      schemas: {
        ...
        CustomerHealthScore: {
          ...
          properties: {
            ...
            activityScore: { type: 'integer' },
            dealScore: { type: 'integer' },
            meetingScore: { type: 'integer' },
            paymentScore: { type: 'integer' },
            contractScore: { type: 'integer' },
        ...
        WeeklySummary: {
          ...
          properties: {
            ...
            overduePayments: { type: 'object', properties: { count: { type: 'integer' }, totalAmount: { type: 'number' } } },
            stagnantCustomers: { type: 'integer' },
            transitionSuggestions: { type: 'integer' },
            topMetrics: { type: 'object', properties: { totalActive: { type: 'integer' }, averageHealthScore: { type: 'integer' }, conversionRate: { type: 'number' } } },
          },
        },
      },
    },
    tags: [
      ...
      { name: 'CustomerTags', description: '고객 태그/세그먼트 관리 API' },
      { name: 'CustomerNotes', description: '고객 메모 관리 API' },
      { name: 'CustomerDocuments', description: '고객 문서 관리 API' },
      { name: 'HealthScore', description: '고객 건강도/이탈 위험 API' },
      { name: 'AuditLog', description: '감사 추적/라이프사이클 API' },
      { name: 'DataQuality', description: '데이터 품질/중복 감지 API' },
      { name: 'FilterPresets', description: '필터 프리셋 관리 API' },
      { name: 'CustomFields', description: '커스텀 필드 관리 API' },
      { name: 'CustomerAnalytics', description: '고객 분석/KPI API' },
      { name: 'ImportExport', description: '고객 데이터 가져오기/내보내기 API' },
    ],
  },
  apis: ['./src/routes/*.ts'],
};
