...
{id:9,num:9,n:"광감작(Harber)",fn:"광감작성시험 Harber법 (동물이용)",c:"광독성/광감작",s:"Guinea Pig",d:"단회",desc:"- 수컷 5마리/군\n- 대조1, 시험1, 양성대조1\n- UV 280~480nm 흡수 없을 시 면제",p:16000000,w:7,gl:["","","","수컷 5마리/군"]},
...
{id:3,num:3,n:"설치류 4주 반복 SEND",fn:"설치류 4주 반복 독성시험 SEND",c:"반복/단회독성",p:20000000,w:"2-3",gl:["CDISC SEND","","",""],note:"회복군/TK 별도"},
{id:4,num:4,n:"설치류 26주 반복 SEND",fn:"설치류 26주 반복 독성시험 SEND",c:"반복/단회독성",p:35000000,w:"2-3",gl:["CDISC SEND","","",""],note:"회복군/TK 별도"},
{id:5,num:5,n:"비설치류 4주 반복 SEND",fn:"비설치류 4주 반복 독성시험 SEND",c:"반복/단회독성",p:20000000,w:"2-3",gl:["CDISC SEND","","",""],note:"회복군/TK 별도"},
{id:6,num:6,n:"비설치류 13주 반복 SEND",fn:"비설치류 13주 반복 독성시험 SEND",c:"반복/단회독성",p:25000000,w:"2-3",gl:["CDISC SEND","","",""],note:"회복군/TK 별도"},
{id:7,num:7,n:"비설치류 26주 반복 SEND",fn:"비설치류 26주 반복 독성시험 SEND",c:"반복/단회독성",p:35000000,w:"2-3",gl:["CDISC SEND","","",""],note:"회복군/TK 별도"},
...
{id:14,num:14,n:"배태자(랫드) SEND",fn:"배태자발생시험(랫드) SEND",c:"생식독성",p:35000000,w:"2-3",gl:["CDISC SEND","","",""],note:"TK 별도"},
{id:15,num:15,n:"배태자(토끼) SEND",fn:"배태자발생시험(토끼) SEND",c:"생식독성",p:35000000,w:"2-3",gl:["CDISC SEND","","",""],note:"TK 별도"}
];
...
{id:3,num:3,n:"설치류 4/13주 반복 CTD",fn:"설치류 4,13주 반복 독성시험 CTD 작성",c:"반복/단회독성",p:1000000,w:"6-8",gl:["CTD Module 2.6","","",""],note:"회복군/TK 별도"},
{id:4,num:4,n:"설치류 26주 반복 CTD",fn:"설치류 26주 반복 독성시험 CTD 작성",c:"반복/단회독성",p:1000000,w:"6-8",gl:["CTD Module 2.6","","",""],note:"회복군/TK 별도"},
...
{id:7,num:7,n:"비설치류 4/13주 반복 CTD",fn:"비설치류 4,13주 반복 독성시험 CTD 작성",c:"반복/단회독성",p:1000000,w:"6-8",gl:["CTD Module 2.6","","",""],note:"회복군/TK 별도"},
{id:8,num:8,n:"비설치류 26/39주 반복 CTD",fn:"비설치류 26,39주 반복 독성시험 CTD 작성",c:"반복/단회독성",p:1000000,w:"6-8",gl:["CTD Module 2.6","","",""],note:"회복군/TK 별도"},
...
{id:19,num:19,n:"수태능 CTD",fn:"수태능 및 초기배 발생시험 CTD 작성",c:"생식독성",p:1000000,w:"6-8",gl:["CTD Module 2.6","","",""],note:"회복군/TK 별도"},
{id:20,num:20,n:"배태자(Rat) CTD",fn:"배태자 발생시험(Rat) CTD 작성",c:"생식독성",p:1000000,w:"6-8",gl:["CTD Module 2.6","","",""]},
{id:21,num:21,n:"배태자(Rabbit) CTD",fn:"배태자 발생시험(Rabbit) CTD 작성",c:"생식독성",p:1000000,w:"6-8",gl:["CTD Module 2.6","","",""]},
{id:22,num:22,n:"출생전후 CTD",fn:"출생전후 발생 및 모체기능 CTD 작성",c:"생식독성",p:1000000,w:"6-8",gl:["CTD Module 2.6","","",""]},
...
{id:3,num:3,n:"설치류 4/13주 번역",fn:"설치류 4,13주 반복 독성시험 영문보고서",c:"반복/단회독성",p:2500000,w:"6-8",gl:["","","",""],note:"회복군/TK 별도"},
{id:4,num:4,n:"설치류 26주 번역",fn:"설치류 26주 반복 독성시험 영문보고서",c:"반복/단회독성",p:2500000,w:"6-8",gl:["","","",""],note:"회복군/TK 별도"},
...
{id:7,num:7,n:"비설치류 4/13주 번역",fn:"비설치류 4,13주 반복 독성시험 영문보고서",c:"반복/단회독성",p:2500000,w:"6-8",gl:["","","",""],note:"회복군/TK 별도"},
{id:8,num:8,n:"비설치류 26/39주 번역",fn:"비설치류 26,39주 반복 독성시험 영문보고서",c:"반복/단회독성",p:2500000,w:"6-8",gl:["","","",""],note:"회복군/TK 별도"},
...
{id:20,num:20,n:"수태능 번역",fn:"수태능 및 초기배 발생시험 영문보고서",c:"생식독성",p:2500000,w:"6-8",gl:["","","",""]},
{id:21,num:21,n:"배태자(Rat) 번역",fn:"배태자 발생시험(Rat) 영문보고서",c:"생식독성",p:2500000,w:"6-8",gl:["","","",""]},
{id:22,num:22,n:"배태자(Rabbit) 번역",fn:"배태자 발생시험(Rabbit) 영문보고서",c:"생식독성",p:2500000,w:"6-8",gl:["","","",""]},
{id:23,num:23,n:"출생전후 번역",fn:"출생전후 발생 및 모체기능 영문보고서",c:"생식독성",p:2500000,w:"6-8",gl:["","","",""]},
